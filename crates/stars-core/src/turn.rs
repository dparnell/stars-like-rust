...
pub fn generate_turn_with_orders(
    ...
    // the TurinDrone's, the Robotoid's and the Automitron's turns are
    // transcribed, and the other three run the TurinDrone's middle until
    // theirs are (`ai::personality`).
