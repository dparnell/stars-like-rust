...
//!
//! The *identification* here is certain: it is read straight out of `DoAiTurn`
//! (`1088:0000`), whose `switch` on the player's mode word names all seven
//! routines. The AI's actual decision-making is not implemented. See
//! `docs/formulas/ai.md` for the map of the ~95 disassembled functions behind
//! it and for why the available fixtures cannot yet verify a transcription of
//! them.
