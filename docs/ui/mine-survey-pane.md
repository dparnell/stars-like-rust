...
Status: **layout and text recovered**; the planet and fleet summaries are
...
given as text); the space objects, which this project's scanner cannot select
yet; and the detonate checkbox.
